...
Get-AppxPackage *549981C3F5F10* | Remove-AppxPackage -Allusers
Get-AppxPackage *aimgr* | Remove-AppxPackage -Allusers
...
Get-AppxPackage *crossdevice* | Remove-AppxPackage -Allusers
...
Get-AppxPackage *office* | Remove-AppxPackage -Allusers
...
Get-AppxProvisionedPackage -Online | ? DisplayName -like '*549981C3F5F10*' | Remove-AppxProvisionedPackage -Online
Get-AppxProvisionedPackage -Online | ? DisplayName -like '*aimgr*' | Remove-AppxProvisionedPackage -Online
...
Get-AppxProvisionedPackage -Online | ? DisplayName -like '*crossdevice*' | Remove-AppxProvisionedPackage -Online
...
Get-AppxProvisionedPackage -Online | ? DisplayName -like '*feedback*' | Remove-AppxProvisionedPackage -Online
...
Get-AppxProvisionedPackage -Online | ? DisplayName -like '*office*' | Remove-AppxProvisionedPackage -Online
